...
void auton7() {
    ...
    enable_pid = true;
    pros::delay(400);
    chassis.moveToPoint(0, -40, 2000, {.forwards = false, .maxSpeed = 80});
    chassis.turnToPoint(-23.5, -40, 2000);
    intakeStop = false;
    intakeTime = 10000;
    chassis.moveToPoint(-23.5, -40, 2000);
    chassis.moveToPoint(-63, -39, 2000,{.maxSpeed = 40});
    pros::delay(200);
    chassis.turnToPoint(-43, -55, 2000);
    chassis.moveToPoint(-43, -55, 2000,{.maxSpeed = 70});
    pros::delay(1000);
